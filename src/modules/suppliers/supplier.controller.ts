...
router.post('/', requirePermission('suppliers', 'write'), asyncHandler(async (req, res) => {
  try {
...
router.patch('/:supplierId', requirePermission('suppliers', 'write'), asyncHandler(async (req, res) => {
  try {
...
router.delete('/:supplierId', requirePermission('suppliers', 'admin'), asyncHandler(async (req, res) => {
  try {
