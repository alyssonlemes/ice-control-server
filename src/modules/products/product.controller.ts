...
router.get('/:productId', requirePermission('products', 'read'), async (req, res) => {
...
router.patch('/:productId', requirePermission('products', 'write'), async (req, res) => {
  try {
...
router.delete('/:productId', requirePermission('products', 'admin'), async (req, res) => {
  try {
